...
**Era / setting:** Late 20th century onward (contested label)  
...
**Plain version:** Neoliberalism is analyzed here as a political-economic pattern with distinctive ownership, market, and authority arrangements—not as a single timeless nation.
...
| Dimension | Summary |
|---|---|
| Ownership | Private ownership expanded via privatization and marketization |
| Property regime | Strong; intellectual property and finance emphasized |
| Markets | Markets actively constructed and extended into new domains |
| Government / polity | Strong state as market-maker: competition rules, monetary regimes, globalization architecture |
| Labor / work | Flexible labor markets; unions often weakened relative to mid-century peaks |
| Power & concentration | Competition policy varies; finance and platform concentration recurring issues |
| Accountability | Price signals, independent agencies, and international economic rules |
...
**Strengths often cited:** Anti-inflation monetary credibility (claimed); Trade integration; Entrepreneurial dynamism.
...
**Risks tagged in the matrix:** Financial instability; Inequality; Democratic backlash; Label overuse.
...
- [Laissez-faire capitalism](/compare/laissez-faire-capitalism/) (`CC-SYS-LAISSEZ-FAIRE-CAPITALISM`)
- [Ordoliberalism](/compare/ordoliberalism/) (`CC-SYS-ORDOLIBERALISM`)
- [Keynesian / managed capitalism](/compare/keynesian-managed-capitalism/) (`CC-SYS-KEYNESIAN-MANAGED-CAPITALISM`)
- [Shareholder-primacy capitalism](/compare/shareholder-primacy-capitalism/) (`CC-SYS-SHAREHOLDER-PRIMACY-CAPITALISM`)

## 10. Relationship to Constitutional Capitalism

Overlaps on markets and property; CC rejects reducing constitutional order to market efficiency alone
