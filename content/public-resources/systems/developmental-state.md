...
**Era / setting:** Late 20th-century East Asian industrialization literature  
...
**Plain version:** Developmental state is analyzed here as a political-economic pattern with distinctive ownership, market, and authority arrangements—not as a single timeless nation.
...
| Dimension | Summary |
|---|---|
| Ownership | Private firms guided by selective state industrial policy |
| Property regime | Strong but politically conditional in strategic sectors |
| Markets | Export markets central; domestic markets often steered |
| Government / polity | Pilot agencies, credit steering, performance discipline |
| Labor / work | Varies; often repression or incorporation during high-growth phases |
| Power & concentration | National champions and conglomerates cultivated then sometimes disciplined |
| Accountability | Performance legitimacy and bureaucratic insulation (contested) |
...
**Strengths often cited:** Rapid industrialization capacity; Learning-by-doing coordination.
...
**Risks tagged in the matrix:** Authoritarian politics; Crony degeneration; Hard mid-income transitions.
...
- [Mercantilism](/compare/mercantilism/) (`CC-SYS-MERCANTILISM`)
- [State capitalism](/compare/state-capitalism/) (`CC-SYS-STATE-CAPITALISM`)
- [Crony capitalism](/compare/crony-capitalism/) (`CC-SYS-CRONY-CAPITALISM`)
- [Authoritarian market economy / illiberal capitalism](/compare/authoritarian-market-economy/) (`CC-SYS-AUTHORITARIAN-MARKET-ECONOMY`)

## 10. Relationship to Constitutional Capitalism

CC rejects authoritarian insulation; may study performance discipline without importing unaccountable pilot agencies
