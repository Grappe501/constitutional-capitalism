...
**Era / setting:** Postwar West Germany and related European debates  
...
**Plain version:** Social-market economics is analyzed here as a political-economic pattern with distinctive ownership, market, and authority arrangements—not as a single timeless nation.
...
| Dimension | Summary |
|---|---|
| Ownership | Private ownership within a social legal order |
| Property regime | Strong |
| Markets | Markets coordinate under social safeguards |
| Government / polity | Maintains competition and social protection |
| Labor / work | Labor protections and social partnership |
| Power & concentration | Strong competition policy |
| Accountability | Constitutional democratic law |
...
**Strengths often cited:** Competitive dynamism with social security.
...
**Risks tagged in the matrix:** Complexity; Fiscal demands; Corporatist insider risk.
...
- [Corporatism](/compare/corporatism/) (`CC-SYS-CORPORATISM`)
...
Close comparative reference, not an identity
