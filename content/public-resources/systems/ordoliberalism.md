...
**Era / setting:** Freiburg School; postwar German economic constitution debates  
...
**Plain version:** Ordoliberalism is analyzed here as a political-economic pattern with distinctive ownership, market, and authority arrangements—not as a single timeless nation.
...
| Dimension | Summary |
|---|---|
| Ownership | Private ownership under a competitive order |
| Property regime | Strong |
| Markets | Markets require an ordering legal framework to remain free |
| Government / polity | Strong rule-setting state; limited discretionary industrial direction |
| Labor / work | Labor protected within legal order |
| Power & concentration | Prevents monopolies and privileges as constitutional-economic duty |
| Accountability | Rule of law and competition order |
...
**Strengths often cited:** Anti-monopoly clarity; Order-based liberalism.
...
**Risks tagged in the matrix:** May understate distributional conflict; Technocratic rigidity risk.
...
Major intellectual comparison for CC's competition and anti-privilege aims
