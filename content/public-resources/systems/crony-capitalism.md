...
**Family:** Diagnostic  
**Era / setting:** Recurrent pathology across market eras  
...
**Plain version:** Crony capitalism is analyzed here as a political-economic pattern with distinctive ownership, market, and authority arrangements—not as a single timeless nation.
...
| Dimension | Summary |
|---|---|
| Ownership | Nominally private ownership with privileged political access |
| Property regime | Formal but selectively applied |
| Markets | Markets distorted by favors, barriers, and selective enforcement |
| Government / polity | Distributes privileges, bailouts, and protection to connected firms |
| Labor / work | Labor subject to privileged firms' market power |
| Power & concentration | Protects favored incumbents |
| Accountability | Patronage networks |
...
**Strengths often cited:** Can mobilize aligned investment quickly; Predictability for insiders.
...
**Risks tagged in the matrix:** Corruption; Weak competition; Public cynicism.
...
- [Kleptocracy](/compare/kleptocracy/) (`CC-SYS-KLEPTOCRACY`)
- [Developmental state](/compare/developmental-state/) (`CC-SYS-DEVELOPMENTAL-STATE`)

## 10. Relationship to Constitutional Capitalism

Directly contrary to CC
