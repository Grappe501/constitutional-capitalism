# Research Domain: Government Capacity, Public Service, and Institutional Modernization

**Website domain title:** Public Service and the 21st-Century State  
**Domain status:** Phase 2 architecture — full research domain  
**Framework:** `data/project/government_capacity_framework.json`  
**Diagnosis brief:** `content/research/national-diagnosis/23-government-capacity-public-service.md`  
...
1. Begin Arkansas Public Authority Inventory structure (entity registry slots) without inventing entities.  
2. Register GAO/state auditor/digital.gov / Census of Governments sources.  
3. Attach baseline indicators only when sourced.  
4. Apply Government Capacity Test (`CC-GTEST-*`) to future proposals.
