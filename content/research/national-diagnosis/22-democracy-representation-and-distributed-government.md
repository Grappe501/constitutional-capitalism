...
**Phase:** 2 — Diagnosis Research Foundation (second constitutional spine; sourced first-pass queued for 2.1)
...
Quantitative claims about competitiveness, donor concentration, participation, and trust remain **pending** source registration.
...
- No democracy baseline metrics sourced yet beyond legal/institutional notes.
- Campaign finance, lobbying access, local preemption, and legislative transparency modules pending.
...
1. Register FEC, Census, state election/redistricting primary sources.  
2. Attach competitiveness, participation, and finance baseline values only when sourced.  
