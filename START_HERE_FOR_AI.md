...
- **Constitutional Citizenship Doctrine** is a core doctrine (`CC-PRIN-30`, `CC-DEV-068`–`073`) — self-government requires education; democracy as a skill; primary question is preparation for self-government, not voting age alone; participatory pathway; Youth Leadership Councils (adults remain legally responsible); Civic Graduation portfolio; schools as community laboratories; civic service as contribution; earlier local voting only as preparation-conditioned pilots to measure — do **not** declare voting begins at 16; no invented civics-outcome statistics (`CC-DEC-067`/`068`)
