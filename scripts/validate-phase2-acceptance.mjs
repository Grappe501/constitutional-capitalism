...
if (baselineStatus.sourced_metrics !== 42) {
  warn(
    `sourced_metrics is ${baselineStatus.sourced_metrics} (canonical operating snapshot expected 42 after RCIP baseline-aligned series expansion)`
  );
} else ok("baseline sourced count remains 42/64");
