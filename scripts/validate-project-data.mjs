...
const validations = [
  ...
  ['data/project/constitutional_defense_framework.json','schemas/constitutional_defense_framework.schema.json'],
  ['data/project/civic_wealth_framework.json','schemas/civic_wealth_framework.schema.json'],
